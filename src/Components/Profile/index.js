                ...
                <div className="p-16">
                    ...
                    <div className="bg-slate-200 mt-4">
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className=" p-2 border-2 border-slate-300 w-full">
                                {userAddressDetails.is_given==="0"?<Link to={`/address`}><button className="w-32 p-2 bg-black text-white mr-6">Add Address</button></Link>:<h1>{userAddressDetails.address}</h1>}
                            </div>
                        </div>
                    </div>
