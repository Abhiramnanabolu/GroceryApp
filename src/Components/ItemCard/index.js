...
class ItemCard extends Component {
    ...
    onClickAddBtn=async(productId)=>{
        ...
        const apiUrl = 'http://ec2-13-200-215-253.ap-south-1.compute.amazonaws.com:8080/ec/cart/add';
    ...
    addToCart = async () => {
        const q = this.state
        const {pdetails}=this.props
        const apiUrl = 'http://ec2-13-200-215-253.ap-south-1.compute.amazonaws.com:8080/ec/cart/update-quantity';
        const uId = Cookies.get('uid')
        const requestData = {
            method: 'PUT',
            headers: {
    ...
    removeFromCart = async () => {
        ...
        const {pdetails}=this.props
        const apiUrl = 'http://ec2-13-200-215-253.ap-south-1.compute.amazonaws.com:8080/ec/cart/remove';
        const uId = Cookies.get('uid')
        const requestData = {
            method: 'DELETE',
            headers: {
